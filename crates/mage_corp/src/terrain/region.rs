...
// ) -> Vec<TerrainRegion> { let render_cube_origin = target_location
...
//   // map to 0.0..1.0
//   let target_float_coords = ((offset_target / config.render_dist) + 1.0) /
// 2.0;   let target_lod_coords =
...
//       let pos = (Vec3::from_array(chunk.position().float_coords()) * 2.0 -
// 1.0)
//         * config.render_dist
//         * 2.0
//         + render_cube_origin;
